			...
			<div className="p-2 md:p-3">
				...
				<div className="flex items-center justify-between mt-2">
					...
					<button
						...
						className={`ml-2 inline-flex items-center justify-center p-1 rounded-md transition-colors text-sm ${
							isFavorite ? "bg-pink-600 text-white" : "bg-white/5 text-white/80"
						}`}
